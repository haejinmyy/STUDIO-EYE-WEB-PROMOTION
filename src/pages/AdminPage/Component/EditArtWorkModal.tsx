...
function EditArtWorkModal({ item, onSave, onCancel }: any) {
  ...
  const selectedImageComponents = selectedImages.map((image, index) => (
    <div key={index}>
      <img
        ...
        width="200"
      />
      <StyledImageDeleteButton onClick={() => handleRemoveImage(index)}>
        X
      </StyledImageDeleteButton>
    </div>
  ));

  const imagePreviewComponents = existingImageUrlList.map(
    (imagePreview, index) => (
      <div key={index}>
      ...
      <Modal>
        ...
        <InputDiv>
          ...
          <InputElement
            ...
            onChange={(e) =>
              setEditedItem({ ...editedItem, department: e.target.value })
            }
          />
        </InputDiv>
        <InputDiv>
        ...
        <InputDiv>
          ...
          <InputElement
            ...
            onChange={(e) =>
              setEditedItem({ ...editedItem, client: e.target.value })
            }
          />
        </InputDiv>
        <InputDiv>
        ...
        <OverviewDiv>
          ...
          <OverviewTextArea
            ...
            onChange={(e) =>
              setEditedItem({ ...editedItem, overView: e.target.value })
            }
          />
        </OverviewDiv>
        <div>
