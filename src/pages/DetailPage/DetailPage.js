...
import DetailTransition from '../../comp/Common/DetailTransition';
...
const DetailPage = () => {
  ...
  return (
    <Body>
      ...
      <MainSection>
        <BasicInfo>
          <ProjTitle>똑똑! 보이는 백과사전</ProjTitle>
          <ProductionTeam>제작 : 제작2실(스아)</ProductionTeam>
      ...
      <DetailSection>
        <DetailBox>
          ...
          <DetailContent>Entertainment</DetailContent>
        </DetailBox>
        <DetailBox>
          <DetailTitle>Client</DetailTitle>
          <DetailContent>(주)엘지유플러스</DetailContent>
        </DetailBox>
        <DetailBox>
